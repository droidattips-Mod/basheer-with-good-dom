...
export const metadata: Metadata = {
  title: "رافعات النصر | تأجير معدات ثقيلة ورافعات في المملكة العربية السعودية",
  description:
    "شركة رافعات النصر متخصصة في تأجير المعدات الثقيلة والرافعات بأسطول حديث وفريق مدرب. خدمة موثوقة في جميع مناطق المملكة. اتصل: 0558204317",
  keywords:
    "تأجير معدات ثقيلة, تأجير رافعات, تأجير كرينات, معدات إنشائية, إيجار معدات السعودية, رافعات النصر",
  openGraph: {
