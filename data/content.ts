...
export const translations: Record<Locale, LocaleContent> = {
  ar: {
    ...
    hero: {
      title: "رافعات النصر",
      highlight: "لتأجير المعدات الثقيلة والرافعات في المملكة العربية السعودية",
      subtitle: "رافعات النصر تقدم خدمات تأجير المعدات الثقيلة منذ أكثر من 15 عاماً، بأسطول متنوع يشمل الرافعات الشوكية، الكرينات، السيزرلفت، البوم تراك، والحفارات. نخدم مشاريع البناء والصناعة في الرياض وجدة والدمام وجميع مناطق المملكة، مع فريق مدرب وخدمة 24/7 لضمان استمرارية أعمالك بأعلى معايير الجودة والسلامة.",
